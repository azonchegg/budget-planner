...
import { CustomCategory, Settings as SettingsType } from '../types';
...
const predefinedColors = [
  ...
  '#F43F5E', '#8B5A2B', '#6B7280', '#14B8A6', '#A855F7'
];

export function CategoryManagement({ settings, onSettingsChange }: CategoryManagementProps) {
